...
KANBAN_GUIDANCE = (
    ...
    "`kanban_block(reason=\"review-required: <one-line summary>\")` to move "
    "it to In Review. A reviewer completes it on approval or calls "
    "`kanban_block(reason=\"changes-requested: <one-line summary>\")` to return "
    "it to In Progress. Reviewing-then-"
